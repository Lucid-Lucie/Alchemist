...
public class EffectDisplacement extends InstantEffect
{
    ...
    {
        // Displacement I has 1/8, Displacement II has 1/4.
        int value = amplifier == 0 ? 8 : 4;
        ...
        if (random.nextInt(value) == 0)
        {
            ...
            if (entityLivingBaseIn.hasItemInSlot(MAINHAND)) list.add(MAINHAND);
            if (entityLivingBaseIn.hasItemInSlot(OFFHAND)) list.add(OFFHAND);
